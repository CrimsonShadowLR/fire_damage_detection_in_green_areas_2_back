...
class Normalize:  #VHR PeruSat
    def __init__(self,mean,std,maxi=3521):
...
class Normalize2:  #HR Sentinel
    def __init__(self,maxi=1, mean=(0.11946253, 0.12642327, 0.13482856, 0.15008255), std=(0.08853241, 0.07311754, 0.06746538, 0.10958234)):
        self.mean = mean
        self.std = std
        self.maxi = maxi
